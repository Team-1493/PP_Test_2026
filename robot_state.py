...
class RobotState():
    ...
    def displayState(self):
        SmartDashboard.putNumber("Vx: ",round(self.getVx(),3))
        SmartDashboard.putNumber("Vy: ",round(self.getVy(),3))
        SmartDashboard.putNumber("Rot Rate: ",round(self.getRotationalSpeedsDPS(),3))   
        SmartDashboard.putNumber("Rot Rate rps: ",round(self.getRotationalSpeedsRPS(),3))           
        SmartDashboard.putNumber("X: ",round(self.getX(),3))
        SmartDashboard.putNumber("y: ",round(self.getY(),3))
        SmartDashboard.putNumber("Rot: ",round(self.getRotationDeg(),3))                  
